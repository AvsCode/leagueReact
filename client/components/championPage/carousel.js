    ...
    render(){
        return(
            <div className='carousel'>
                ...
                <button className='carouselButton carouselLeft'onClick={this.changeImage}>&#xab;</button>
                <button className='carouselButton carouselRight'onClick={this.changeImage}>&#xbb;</button>
